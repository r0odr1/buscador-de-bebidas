        ...
        >
          <div className="relative">
            <input
              name="prompt"
              id="prompt"
              className="bg-white/10 border border-purple-300 placeholder-white/50 p-5 rounded-xl w-full focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:border-purple-400 transition-all duration-300 pr-16"
